...
public:
  ...
  // Set angled values a \in [-\pi, \pi)
  //
  // Inputs:
  //   a  #V by 1 list of angled values
  //   da #E by 1 list of differntial form of angled values
  //   EV #E by 2 list of which vertices are adjacent to edges
  void set_angles(const Eigen::VectorXd &a, const Eigen::VectorXd &da,
  ...
  Eigen::MatrixXd FV_angles;
  Eigen::MatrixXd F_indices;
...
//   {
//     inline void serialization(bool s, rp::opengl::ViewerData& obj, std::vector<char>& buffer)
//     {
//       SERIALIZE_MEMBER(V);
//       SERIALIZE_MEMBER(F);
...
//     }
//     template<>
//     inline void serialize(const rp::opengl::ViewerData& obj, std::vector<char>& buffer)
//     {
//       serialization(true, const_cast<rp::opengl::ViewerData&>(obj), buffer);
//     }
//     template<>
//     inline void deserialize(rp::opengl::ViewerData& obj, const std::vector<char>& buffer)
//     {
//       serialization(false, obj, const_cast<std::vector<char>&>(buffer));
//       obj.dirty = rp::opengl::MeshGL::DIRTY_ALL;
//     }
//   }
// }
