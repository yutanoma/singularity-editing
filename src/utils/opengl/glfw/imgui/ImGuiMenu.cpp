...
void ImGuiMenu::init(rp::opengl::glfw::Viewer *_viewer)
{
...
void ImGuiMenu::post_resize(int width, int height)
{
  if (context_)
  {
...
// Mouse IO
bool ImGuiMenu::mouse_down(int button, int modifier)
{
  ImGui_ImplGlfw_MouseButtonCallback(viewer->window, button, GLFW_PRESS, modifier);
  return ImGui::GetIO().WantCaptureMouse;
}

bool ImGuiMenu::mouse_up(int button, int modifier)
{
  //return ImGui::GetIO().WantCaptureMouse;
...
bool ImGuiMenu::mouse_scroll(float delta_y)
{
...
// Keyboard IO
bool ImGuiMenu::key_pressed(unsigned int key, int modifiers)
{
  ImGui_ImplGlfw_CharCallback(nullptr, key);
  return ImGui::GetIO().WantCaptureKeyboard;
}

bool ImGuiMenu::key_down(int key, int modifiers)
{
  ImGui_ImplGlfw_KeyCallback(viewer->window, key, 0, GLFW_PRESS, modifiers);
  return ImGui::GetIO().WantCaptureKeyboard;
}

bool ImGuiMenu::key_up(int key, int modifiers)
{
...
void ImGuiMenu::draw_viewer_menu()
{
  ...
  if (ImGui::CollapsingHeader("Viewing Options", ImGuiTreeNodeFlags_DefaultOpen))
  {
    ...
    {
      using RT = rp::opengl::ViewerCore::RotationType;
  ...
  if (ImGui::CollapsingHeader("Draw Options", ImGuiTreeNodeFlags_DefaultOpen))
  {
    ...
    {
      viewer->data().dirty |= rp::opengl::MeshGL::DIRTY_NORMAL;
    }
