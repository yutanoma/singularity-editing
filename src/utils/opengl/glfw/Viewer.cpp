...
static rp::opengl::glfw::Viewer * __viewer;
...
static void glfw_mouse_press(GLFWwindow* window, int button, int action, int modifier)
{
  ...
  rp::opengl::glfw::Viewer::MouseButton mb;

  if (button == GLFW_MOUSE_BUTTON_1)
    mb = rp::opengl::glfw::Viewer::MouseButton::Left;
  else if (button == GLFW_MOUSE_BUTTON_2)
    mb = rp::opengl::glfw::Viewer::MouseButton::Right;
  else //if (button == GLFW_MOUSE_BUTTON_3)
    mb = rp::opengl::glfw::Viewer::MouseButton::Middle;
...
namespace glfw
{
  ...
  int Viewer::launch(bool resizable /*= true*/, bool fullscreen /*= false*/,
  ...
  int  Viewer::launch_init(bool resizable, bool fullscreen,
    ...
    next_core_id(2)
  {
    ...
    const std::string usage(R"(rp::opengl::glfw::Viewer usage:
  [drag]  Rotate scene
  ...
  bool Viewer::load_mesh_from_file(
  ...
  bool Viewer::load_scene(std::string fname)
  {
  ...
  bool Viewer::save_scene(std::string fname)
  {
  ...
  void Viewer::open_dialog_load_mesh()
  {
    std::string fname = igl::file_dialog_open();
  ...
  void Viewer::open_dialog_save_mesh()
  {
    std::string fname = igl::file_dialog_save();
