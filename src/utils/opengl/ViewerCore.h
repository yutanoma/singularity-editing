...
namespace igl {
  namespace serialization {
    ...
    inline void serialization(bool s, rp::opengl::ViewerCore& obj, std::vector<char>& buffer)
    {
    ...
    template<>
    inline void serialize(const rp::opengl::ViewerCore& obj, std::vector<char>& buffer)
    {
      serialization(true, const_cast<rp::opengl::ViewerCore&>(obj), buffer);
    }

    template<>
    inline void deserialize(rp::opengl::ViewerCore& obj, const std::vector<char>& buffer)
    {
