...
void rp::opengl::ViewerCore::align_camera_center(
...
void rp::opengl::ViewerCore::get_scale_and_shift_to_fit_mesh(
  const Eigen::MatrixXd& V,
  const Eigen::MatrixXi& F,
  float& zoom,
...
void rp::opengl::ViewerCore::clear_framebuffers()
{
...
void rp::opengl::ViewerCore::draw(
  ViewerData& data,
...
void rp::opengl::ViewerCore::draw_buffer(ViewerData& data,
  bool update_matrices,
...
void rp::opengl::ViewerCore::draw_labels(
  ViewerData& data,
  const rp::opengl::MeshGL::TextGL& labels
){
  using namespace igl;
...
void rp::opengl::ViewerCore::set_rotation_type(
  const rp::opengl::ViewerCore::RotationType & value)
{
  using namespace Eigen;
  using namespace std;
  using namespace igl;
...
void rp::opengl::ViewerCore::set(unsigned int &property_mask, bool value) const
{
  if (!value)
    unset(property_mask);
  else
...
void rp::opengl::ViewerCore::unset(unsigned int &property_mask) const
{
  property_mask &= ~id;
}

void rp::opengl::ViewerCore::toggle(unsigned int &property_mask) const
{
  property_mask ^= id;
}

bool rp::opengl::ViewerCore::is_set(unsigned int property_mask) const
{
  return (property_mask & id);
}

rp::opengl::ViewerCore::ViewerCore()
{
  // Default colors
...
void rp::opengl::ViewerCore::init()
{
}

void rp::opengl::ViewerCore::shut()
{
}
